...
test('이 스터디의 목표(2026-08-27 7차) = 리드 + 목표 4(번호 카드) + 흐름 3 — 대시·AI투·현업 표기 0', () => {
  ...
  expect(html).not.toContain('rc-goal-bar')   // 제목 아래 강조 바 = 2026-09-12 삭제(4차 언더바 폐지와 같은 형태)
...
test('E2 참여 조건 = 문턱 낮은 체크리스트 4행 — 선발 어휘 금지', () => {
  ...
  expect(html).toContain('참여 조건 4가지')   // 경어체 h2 → 개조식(오너 2026-09-12)
  expect(html).not.toContain('이 정도면 충분합니다')
