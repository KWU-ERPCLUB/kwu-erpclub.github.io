...
const OPEN_DAY = '2026-09-01' // 모집 창 안(RECRUIT.window ~ 09-13)
...
test('접수 국면 — 폼 공개일부터 open, 마감 다음 날 after', () => {
  ...
  expect(applyPhase('2026-09-13', {})).toBe('open')   // 마감일 포함(2026-09-11 오너: 09-11 → 09-13 20:00)
  expect(applyPhase('2026-09-14', {})).toBe('after')
