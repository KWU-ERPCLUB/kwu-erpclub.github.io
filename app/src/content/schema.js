...
export const NATURES = ['트렌드', '심층 분석', '도구·활용'] // 성격(글 종류·단일) — 구 '뉴스·동향' = '트렌드'로 개명(2026-07-25 오너). 2026-08-25 오너: 4값→3값 — '활용법·튜토리얼' 폐지(0건, 도감 카드가 흡수)·'도구·프롬프트'→'도구·활용' 개명(spec 도구도감-트랙 D5)
