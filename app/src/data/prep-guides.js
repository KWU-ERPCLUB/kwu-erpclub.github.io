...
// 구조 = { id, 회차, title, lead, groups[{ label, items[] }], note }. item = { id, title, minutes, what, need?, steps[], tips? }.
// 문장 규칙(2026-09-12 오너 재지적 "AI 톤으로 맞추지 마" 반영):
//   · 묶음 라벨 = 하는 일 이름(명사) — 재촉형("지금 바로"·"오늘 안에") 금지
//   · title = 명사형 18자 안(영문 도구명 포함) · what = 2문장(첫 문장 정의 "X는 Y", 둘째 "우리는 Z에 쓴다") · need = 한 줄
//   · steps = 한 줄에 동작 하나, 25자 안, 명사형 종결("…누르기"), 마침표 없음 · 굵게 = 화면에 실제로 적힌 버튼·메뉴 이름 1곳만
//   · tips = 조건문 한 줄씩("카드가 없으면 …") · 추임새("끝", "성공", "꼭") 금지 · 대시(—) 금지
...
export const PREP_GUIDES = [
  {
    ...
    title: 'OT 준비물 7가지',
    date: '2026-09-14',
    lead: '계정 하나, 신청 셋, 설치 둘, 제출 하나. 항목을 누르면 하는 법이 옆에 열린다. 체크는 이 기기에만 남는다.',
    ...
    groups: [
      {
        ...
        items: [
          {
            id: 'pw', title: '비밀번호 바꾸기', minutes: 5,
            what: '워크스페이스 계정은 지금 전원이 같은 초기 비밀번호(000000)다. 바꿔야 내 계정이 된다.',
            steps: [
              'https://kwu-erpclub.github.io/workspace/ 접속',
              '아이디 = 학번, 비밀번호 = 000000 으로 로그인',
              '왼쪽 메뉴에서 **내정보** 누르기 (폰은 아래쪽 탭)',
              '아래로 내려 **설정** 펼치기',
              '**비밀번호 변경**에 새 비밀번호 두 번 입력 (6자 이상)',
              '저장',
            ],
      ...
      },
      {
        ...
        items: [
          {
            id: 'gemini', title: 'Gemini 학생 무료 신청', minutes: 10,
          ...
          {
            id: 'github', title: 'GitHub 계정·학생 혜택', minutes: 15,
            ...
            steps: [
              'https://github.com/signup 에서 이메일, 비밀번호, 아이디(영문) 입력',
              '이메일로 온 인증 코드 입력',
              '오른쪽 위 내 사진에서 **Settings** 누르기',
              '왼쪽 **Emails**에서 학교 이메일 추가, 학교 메일함의 인증 링크 누르기',
              'https://education.github.com/pack 접속',
              '**Sign up for Student Developer Pack** 누르기',
              '학교 이름 Kwangwoon University 입력, 학교 이메일 선택',
              '학생증 사진 요구 시 올리기',
            ],
            tips: [
          ...
          },
          {
            ...
            steps: [
              ...
              '오른쪽 위 내 사진 > Settings > **Copilot** 열기',
              '"Copilot Free" 표시 확인',
            ],
      ...
      },
      {
        ...
        items: [
          {
            id: 'vscode', title: 'VS Code + Copilot', minutes: 15,
            ...
            steps: [
              'https://code.visualstudio.com/ 에서 **Download** 누르기 (운영체제 자동 선택)',
      ...
      },
      {
        ...
        items: [
          {
            id: 'materials', title: '재료 4가지 적어 제출', minutes: 20,
            what: '회차 2(9/21)에서 각자 과목을 놓고 어디를 AI로 줄일지 같이 본다. 그 재료 4가지를 미리 적어 낸다. 한 줄씩이면 된다.',
            need: '① 이번 학기 과목 목록 ② 과목별 자료 형태(PDF 슬라이드 / PPT / 녹음 / 교재만) ③ 시험 방식(객관식 / 서술형 / 과제 대체 / 팀 발표) ④ 매주 반복하는 귀찮은 일 1개(예: 강의 슬라이드를 노션에 옮겨 적기, 조별 회의록 정리)',
            steps: [
              'https://docs.google.com 에서 **새 문서** 만들기',
              '4가지 적기',
              '오른쪽 위 **공유**에서 "제한됨"을 **링크가 있는 모든 사용자**로 변경',
              '**링크 복사**',
              '워크스페이스 홈 탭 > 과제 > 「회차 2 재료 4가지」 열기',
              '링크 붙여넣고 제출'
            ],
            tips: [
              '마감 9/21(월) 18:00.',
