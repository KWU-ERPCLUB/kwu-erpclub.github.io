...
export const AIM_HOOK = '학기가 끝나면 기업이 묻는 AI 역량을 본인 사례로 답한다.'
...
// 이 스터디의 목표(2026-08-27 오너 5차 개정 — "하는 일"이 아니라 **해자**: 혼자 할 때와 무엇이 다른가).
// 멤버 표면 = 취업용 AI 역량(북극성 §3). 내부 운영 프레임(AX 도입 시뮬레이션)은 웹 비표기 — 오너 전용.
// 카피 규칙: 대시 금지, 개조식, AI투 금지(테스트 가드). 구조 = 리드 → 해자 4(뒤집기 카드: 앞 = 혼자서는 / 뒤 = 여기서는) → 한 학기 흐름 3.
export const RECRUIT_GOAL_LEAD = '학기가 끝나면 기업이 묻는 AI 역량을 본인 사례로 답할 수 있다. 그 사례를 혼자서는 만들기 어려운 이유가 아래 넷이다.'

// 해자 4 = [제목, 혼자서는, 여기서는]. 각 면 2문장 이내(줄맞춤).
export const RECRUIT_MOAT = [
  ['새 방식이 매주 들어온다', '쓰던 방식대로만 쓴다. 이번 달에 무엇이 바뀌었는지 모른다.', '운영진이 현업에서 쓰는 방식과 그 주에 바뀐 것을 매주 앞 30분에 보여 준다.'],
  ['내 도구를 쓰는 사람이 생긴다', '만들어도 나만 쓴다. 맞게 만든 건지 알 길이 없다.', '같은 팀이 써 보고 묻는다. 근거는 어디서 났는지, 누가 썼는지, 무엇이 되면 실패인지.'],
  ['기록이 지원서 사례가 된다', '써 본 기억만 남는다. 말로 설명할 것이 없다.', '시킨 것과 안 된 것이 매주 쌓이고 허브에 게재된다. 학기 말에 본인 사례 한 문단이 나온다.'],
  ['유료급 도구를 0원에 쓴다', '무료 한도에 막히거나 돈을 낸다.', '학생 혜택으로 유료급을 쓰는 경로를 세팅 가이드로 준다. 참가비 없음.'],
]
