...
export const RECRUIT = {
  ...
  활동기간: '2026-09 ~ 12 (2학기)',
  일정: {
    전반: { 기간: '9월 ~ 10월 초', 회차: 4 },   // 2026-08-13 2단 재편 — 1차 = 차시 1~4
    휴지: { 라벨: '10월 중순', start: '2026-10-07', end: '2026-10-26' },   // 표기 = '시험기간'(오너 2026-08-14)
    후반: { 기간: '10월 말 ~ 12월' },
  },
}
...
export const PHASES = {
  p1: {
    ...
    쇼케이스주간: '2026-09-28', // §2 1차 마지막 회 = 1차 쇼케이스 + 팀 결성(2026-08-13 재편 값)
    회차: RECRUIT.일정.전반.회차,
  },
  휴지: {
