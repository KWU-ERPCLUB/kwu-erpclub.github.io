...
export const AIM_HOOK = '학기 말에 기업이 묻는 AI 역량을 본인 사례로 답한다.'
...
export const RECRUIT_GOAL_LEAD = '학기 말에 기업이 묻는 AI 역량을 본인 사례로 답한다.'

// 해자 3 = [제목(명사형), 혼자서는, 여기서는]. 각 면 한 문장. 2026-08-27 6차: 유료급 도구 카드 삭제(해자 아님), 문장형 제목 폐지.
export const RECRUIT_MOAT = [
  ['현업 방식 매주 공유', '쓰던 대로 쓴다.', '운영진이 현업에서 쓰는 방식을 매주 시연한다.'],
  ['사용자와 검수자', '만들어도 나만 쓴다.', '팀원이 써 보고 근거, 사용자, 실패 조건을 묻는다.'],
  ['지원서에 쓰는 기록', '써 본 기억만 남는다.', '시킨 것과 안 된 것이 매주 쌓여 학기 말 본인 사례가 된다.'],
]
