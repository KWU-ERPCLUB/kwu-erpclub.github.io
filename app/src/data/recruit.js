...
// 값 근거 = RECRUIT_DO 1번 항목(내 과제 도구 제작).
export const AIM_HOOK = '과제·팀플·발표에 쓸 AI 도구를 각자 만들고, 학기 내내 쓴다.'
...
// 2026-08-27 오너 개정 — 기고 의무 폐지(발행 = 운영진)·설명 보강("하는 일이 안 읽힌다")·웹 제작 오인 차단.
export const RECRUIT_DO = [
  ['내 과제 도구 만들기', '리포트·시험·팀플에 쓰는 AI 도구를 각자 만든다. 자료를 넣어 둔 노트북, 과제용 지시문, 미니앱. 만든 것을 학기 내내 쓴다.'],
  ['제대로 시키는 법', '질문 한 줄 대신 기준과 자료를 붙여 시키고, 결과를 검수하고, 한 번 만든 것을 다시 쓴다. 코딩 아님.'],
  ['팀 업무 케이스', '2차 구간. 가상 업무 케이스 하나를 팀으로 자동화. 기획은 사람, 구현은 AI. 발표 자료는 만들지 않는다.'],
  ['세미나·인사이트', '인사이트는 운영진이 매주 발행. 주제가 모이면 세미나로 진행.'],
]
