...
export const AIM_HOOK = '과제와 팀 프로젝트에 AI를 적용하고, 그 결과를 AI 역량의 근거로 제시한다.'
...
export const RECRUIT_FACTS = [
  ['스터디', `${RECRUIT.study} — ERP연구회 산하 빅데이터분석·AI 스터디`],   /* 2026-09-11 담당 교수 요청: 모집 페이지 표기만 'MIS'→'빅데이터분석'(AI는 유지 — 실제 활동의 축, 취지·커리큘럼 무변경) */
  ['대상', '경영학부 중심 — 비전공자도 환영'],
  ['인원', '00명 — 추후 확정'],
  ['모집 기간', formatWindow()],
  ['활동 기간', RECRUIT.활동기간],
  ['모임', '매주 월요일 18:00 ~ 20:00 대면 — 공휴일 주간은 과제로 대체'],
  ['준비물', '개인 노트북 필수 — 참가비 없음. 도구는 무료 및 학생 혜택 기준'],
]
...
export const RECRUIT_FIT = [
  ...
  ['직접 만들 의지', '반복 작업 하나를 직접 자동화하는 것이 목표.'],
]
...
export const RECRUIT_GOAL_LEAD = '한 학기 후 참여자가 확보하는 것.'

// 목표 4 = [제목(명사형), 본문]. 2026-08-27 8차: 전문 어투(구어 제거, 명사형 종결).
export const RECRUIT_GOALS = [
  ['업무 효율의 실측', '과제, 시험, 팀 프로젝트에 AI를 적용해 소요 시간과 완성도를 개선한다. 개선 결과는 본인이 직접 확인한다.'],
  ['검증 가능한 AI 역량', '기업이 평가하는 AI 활용 역량의 기준을 이해하고, 학기 말에 본인 사례로 설명한다.'],
  ['최신 동향 학습', '매주 갱신되는 AI 도구와 활용 방식을 함께 학습하고 즉시 적용한다.'],
  ['재사용 가능한 자산', '팀원의 사용과 검수를 거친 도구와 적용 기록을 학기 전체에 걸쳐 축적한다.'],
]

// 한 학기 흐름 3 = [단계, 기간, 본문].
export const RECRUIT_FLOW = [
  ['개인 과제 자동화', '9월 · 개인', '반복 과제 하나를 선정해 AI 도구로 구축하고 학기 중 지속 사용한다.'],
  ['팀 업무 케이스 자동화', '10~11월 · 팀', '팀이 실제로 가진 문제나 준비된 업무 케이스 중 하나를 골라 팀 단위로 자동화한다. 협업 룰을 먼저 정하고 서로 검수한다.'],
  ['최종 발표', '11월 16일', '발표 자료 없이 결정 메모 1장과 실물 시연으로 진행한다.'],
]
