...
export const TAXONOMY = {
  // 어학(2026-08-19 오너) — 자격증 수집 대상 = MIS·데이터 계열 + 어학, 두 갈래뿐이다.
  자격증: [
    { id: 'ADsP' }, { id: 'SQLD' }, { id: '컴활' }, { id: 'SAP' }, { id: '정보처리기사' },
    { id: '빅데이터분석기사' }, { id: '어학' }, { id: '기타' },
  ],
  채용: [
  ...
  // 교내활동(2026-08-19 오너, 구 '대외활동') = 광운대 교내 정보 전용. 매일 루틴이 채운다.
  // 구 값(서포터즈·교육부트캠프·교내프로그램)은 은퇴 — 등록 폼에서만 숨고 기존 행 매칭은 유지된다.
  교내활동: [
    { id: '비교과' }, { id: '특강' }, { id: '튜터·멘토' }, { id: '장학' }, { id: '기타' },
    { id: '서포터즈', retired: true }, { id: '교육부트캠프', retired: true }, { id: '교내프로그램', retired: true },
  ],
}
...
export const CAL_CATEGORIES = ['공모전', '채용', '자격증', '교내활동', '학사', 'AIM']
