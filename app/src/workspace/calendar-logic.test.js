...
import { monthGrid, buildAgenda, itemsOn, upcoming, dday, weeklyContribItems, toKey, isLockedMaterial } from './calendar-logic.js'
...
// 해금(0011): 공개일 미래 = 잠금(링크 미노출), 과거·null = 열림. (2026-08-20 Sessions.jsx 폐지로 이관)
