...
// 성격 칩 = 전체 + 성격 3종. '전체' = 성격 필터 없음(AI in Use 구조: 상단 컨트롤 바 성격 칩).
export const HUB_TAB = '전체'
export const TABS = [HUB_TAB, ...NATURES]

// 성격 ↔ ascii 탭키(URL·CSS 클래스 안정용). Korean URL 인코딩 회피.
// 구 키 'howto'(활용법·튜토리얼) = 2026-08-25 폐지. 기존 URL ?tab=howto는 stateFromSearch가 미지 키 → 허브로 폴백한다.
export const NATURE_KEY = { '트렌드': 'news', '심층 분석': 'analysis', '도구·활용': 'tools' }
