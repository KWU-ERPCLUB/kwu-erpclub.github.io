      ...
      <main className="hub-page">
        ...
        {all.length === 0 ? (
          <div className="hub-empty">
            <p className="hub-empty-title">세미나 기록 아직 없음.</p>
            <p>세미나 개시 후 회차별 축적 — 인지(알기) 회차는 자유 구성, 실습 회차는 준비·진행·재현 가이드 3블록.</p>
            <p className="hub-empty-how">기고 = <code>content/세미나/</code>에 규칙(회차·유형)에 맞는 마크다운 추가 → 자동 게재.</p>
          </div>
        ) : (
