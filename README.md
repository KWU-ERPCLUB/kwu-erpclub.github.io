...
## 현재상태 (2026-07-11 — 메인 개편 v2 구현, 커밋만·push 대기)
- **라이브: https://kwu-erpclub.github.io/** — 조직 KWU-ERPCLUB + GitHub Pages, main push = 자동 배포. ⚠ 메인 v2는 **로컬 커밋 상태(미배포)**
...
## 다음 할 일 (새 세션 재개 지점)
- [ ] **owner 실측**(dev: http://localhost:5173 — 메인 로직·/reports·/log) → 규칙 v2 확정(완료 배지 포함) → **push(=배포) 승인**
